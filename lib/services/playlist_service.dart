...
class PlaylistService {
  ...
  Future<List<AppSong>> _loadAssetSongs() async {
    const audioPaths = [
      'assets/audio/sample_songs/Acoustic Chill - Sample Music - Chill Album.mp3',
      'assets/audio/sample_songs/Blue Sky - Son Tùng - VPop Album.mp3',
      'assets/audio/sample_songs/Love Story - Taylor - Pop Album.mp3',
      'assets/audio/sample_songs/Night Drive - Alan Walker - EDM Album.mp3',
    ];
